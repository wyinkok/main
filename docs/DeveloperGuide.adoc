...
Similarly, to achieve the internal removal of a saved tag, we added a `addSavedTagToInternship` method
within the UnsaveCommand object.
...
To view the entire collection, they can type in a command (yet to implement) that
