...
** What it does:
*** Allows users to search for multiple keywords and all internships containing ANY of the keywords will be listed.
...
that matches any of the keywords. They can then filter from the list to get their desired internship.
