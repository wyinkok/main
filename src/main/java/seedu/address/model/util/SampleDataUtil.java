...
public class SampleDataUtil {
    public static Internship[] getSampleInternships() {
        return new Internship[] {
            ...
            new Internship(new Name("Wealth Springs Holdings Pte Ltd"), new Salary("600"),
            ...
            new Internship(new Name("ClearSK Healthcare Pte Ltd"), new Salary("1000"),
                ...
                new Region("Novena"), new Role("Accounting Financial Analyst"), getTagSet()),
            new Internship(new Name("WE Communications"), new Salary("800"),
                ...
                new Region("Orchard"), new Role("Accounting Servicing Intern Healthcare"), getTagSet()),
            new Internship(new Name("ClearSK Healthcare Pte Ltd"), new Salary("1000"),
                new Email("csk@example.com"), new Address("126 Novena Street 13"), new Industry("Healthcare"),
                new Region("Novena"), new Role("Operation Marketing Assistant"), getTagSet()),
