    ...
    public static Internship[] getSampleInternships() {
        return new Internship[] {
            ...
            new Internship(new Name("ClearSK Healthcare Pte Ltd"), new Salary("1200"),
                ...
                new Region("Novena"), new Role("Financial Data Business Analyst"), getTagSet()),
            ...
            new Internship(new Name("Piece Future Pte Ltd"), new Salary("500"),
                ...
                new Region("Central"), new Role("Business Analyst"), getTagSet()),
            ...
            new Internship(new Name("Tradex Systems Pte Ltd"), new Salary("800"),
                new Email("Tradex@example.com"), new Address("20 Collyer Quay #23-01"), new Industry("IT"),
                new Region("Central"), new Role("Business Development Associate"), getTagSet()),
            new Internship(new Name("Riverview Mobile Solutions"), new Salary("600"),
                new Email("RVMS@example.com"), new Address("8 Burn road #12-02"), new Industry("IT"),
                new Region("West"), new Role("Technology Analyst Intern"), getTagSet()),
            new Internship(new Name("Caproasia"), new Salary("800"),
                new Email("Caproasia@example.com"), new Address("10 Shenton way #11-02"), new Industry("IT"),
                new Region("CBD"), new Role("Web Technology Intern"), getTagSet()),
