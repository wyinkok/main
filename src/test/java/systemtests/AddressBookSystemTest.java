...
public abstract class AddressBookSystemTest {
     ...
     * and the internship list panel displays the persons in the model correctly.
     */
    protected void assertApplicationDisplaysExpected(String expectedCommandInput, String expectedResultMessage,
        ...
        assertListMatching(getInternshipPersonListPanel(), expectedModel.getFilteredInternshipList());
    }

    /**
     * Calls {@code BrowserPanelHandle}, {@code InternshipListPanelHandle} and {@code StatusBarFooterHandle} to remember
     * their current state.
     */
    ...
    private void assertApplicationStartingStateIsCorrect() {
        try {
            ...
            assertListMatching(getInternshipPersonListPanel(), getModel().getFilteredInternshipList());
