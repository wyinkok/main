...
public class CommandTestUtil {
    ...
    static {
        DESC_AMY = new EditInternshipDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withIndustry(VALID_INDUSTRY_AMY).withLocation(VALID_LOCATION_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditInternshipDescriptorBuilder().withName(VALID_NAME_BOB)
                ...
                .withIndustry(VALID_INDUSTRY_BOB).withLocation(VALID_LOCATION_BOB)
