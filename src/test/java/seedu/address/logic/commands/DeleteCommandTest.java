...
public class DeleteCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() throws Exception {
        Internship internshipToDelete = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
        DeleteCommand deleteCommand = prepareCommand(INDEX_FIRST_PERSON);

        String expectedMessage = String.format(DeleteCommand.MESSAGE_DELETE_PERSON_SUCCESS, internshipToDelete);

        ModelManager expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs());
        expectedModel.deletePerson(internshipToDelete);
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonDeleted() throws Exception {
        ...
        expectedModel.deletePerson(internshipToDelete);
        assertNotEquals(internshipToDelete, model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased()));
