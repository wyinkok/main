...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Internship expectedInternship = new InternshipBuilder().withName(VALID_NAME_BOB).withSalary(VALID_SALARY_BOB)
                ...
                .withLocation(VALID_LOCATION_BOB).withRole(VALID_ROLE_BOB).withTags(VALID_TAG_FRIEND).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INDUSTRY_DESC_BOB + LOCATION_DESC_BOB + ROLE_DESC_BOB + TAG_DESC_FRIEND,
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_AMY + INDUSTRY_DESC_BOB + LOCATION_DESC_BOB + ROLE_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedInternship));

        // multiple locations - last location accepted
        assertParseSuccess(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + INDUSTRY_DESC_BOB + LOCATION_DESC_AMY + LOCATION_DESC_BOB + ROLE_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedInternship));

        // multiple locations - last role accepted
        assertParseSuccess(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + INDUSTRY_DESC_BOB + LOCATION_DESC_BOB + ROLE_DESC_AMY + ROLE_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedInternship));
        ...
        Internship expectedInternshipMultipleTags =
                ...
                .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withIndustry(VALID_INDUSTRY_BOB)
                        .withLocation(VALID_LOCATION_BOB).withRole(VALID_ROLE_BOB)
                        .withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND).build();
        assertParseSuccess(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_BOB + LOCATION_DESC_BOB + ROLE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        Internship expectedInternship = new InternshipBuilder().withName(VALID_NAME_AMY).withSalary(VALID_SALARY_AMY)
                ...
                .withLocation(VALID_LOCATION_AMY).withRole(VALID_ROLE_AMY).withTags().build();
        assertParseSuccess(parser, NAME_DESC_AMY + SALARY_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + INDUSTRY_DESC_AMY + LOCATION_DESC_AMY + ROLE_DESC_AMY, new AddCommand(expectedInternship));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + INDUSTRY_DESC_BOB + LOCATION_DESC_BOB + ROLE_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + VALID_INDUSTRY_BOB + LOCATION_DESC_BOB + ROLE_DESC_BOB, expectedMessage);

        // missing location prefix
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_BOB + VALID_LOCATION_BOB + ROLE_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_SALARY_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB
                        + VALID_INDUSTRY_BOB + VALID_LOCATION_BOB + VALID_ROLE_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid industry
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_INDUSTRY_DESC + LOCATION_DESC_BOB + ROLE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Industry.MESSAGE_INDUSTRY_CONSTRAINTS);

        // invalid location
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + INDUSTRY_DESC_BOB + INVALID_LOCATION_DESC + ROLE_DESC_BOB + TAG_DESC_HUSBAND
                        + TAG_DESC_FRIEND,
                Location.MESSAGE_LOCATION_CONSTRAINTS);

        // invalid role
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + INDUSTRY_DESC_BOB + LOCATION_DESC_BOB + INVALID_ROLE_DESC + TAG_DESC_HUSBAND
                        + TAG_DESC_FRIEND,
                Role.MESSAGE_ROLE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_BOB + LOCATION_DESC_BOB + ROLE_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND,
                Tag.MESSAGE_TAG_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + SALARY_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                        + INDUSTRY_DESC_BOB + LOCATION_DESC_BOB + ROLE_DESC_BOB, Name.MESSAGE_NAME_CONSTRAINTS);
