...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INDUSTRY_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedInternship));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_AMY + INDUSTRY_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedInternship));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + SALARY_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + INDUSTRY_DESC_AMY, new AddCommand(expectedInternship));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + INDUSTRY_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + VALID_INDUSTRY_BOB, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_NAME_CONSTRAINTS);

        // invalid salary
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_SALARY_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Salary.MESSAGE_SALARY_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_EMAIL_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + INDUSTRY_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_ADDRESS_CONSTRAINTS);

        // invalid industry
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_INDUSTRY_DESC + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Industry.MESSAGE_INDUSTRY_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INDUSTRY_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND, Tag.MESSAGE_TAG_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + SALARY_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                        + INDUSTRY_DESC_BOB, Name.MESSAGE_NAME_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + SALARY_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INDUSTRY_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
