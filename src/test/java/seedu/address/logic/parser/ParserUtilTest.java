...
public class ParserUtilTest {
    ...
    public void parseSalary_null_throwsNullPointerException() {
        ...
        Assert.assertThrows(NullPointerException.class, () -> ParserUtil.parseSalary((Optional<String>) null));
    }

    @Test
    public void parseSalary_invalidValue_throwsIllegalValueException() {
        Assert.assertThrows(IllegalValueException.class, () -> ParserUtil.parseSalary(INVALID_SALARY));
        Assert.assertThrows(IllegalValueException.class, () -> ParserUtil.parseSalary(Optional.of(INVALID_SALARY)));
    }

    @Test
    public void parseSalary_optionalEmpty_returnsOptionalEmpty() throws Exception {
        assertFalse(ParserUtil.parseSalary(Optional.empty()).isPresent());
    }
    ...
    public void parseSalary_validValueWithoutWhitespace_returnsSalary() throws Exception {
        ...
        assertEquals(Optional.of(expectedSalary), ParserUtil.parseSalary(Optional.of(VALID_SALARY)));
    }

    @Test
    public void parseSalary_validValueWithWhitespace_returnsTrimmedSalary() throws Exception {
        String phoneWithWhitespace = WHITESPACE + VALID_SALARY + WHITESPACE;
        Salary expectedSalary = new Salary(VALID_SALARY);
        assertEquals(expectedSalary, ParserUtil.parseSalary(phoneWithWhitespace));
        assertEquals(Optional.of(expectedSalary), ParserUtil.parseSalary(Optional.of(phoneWithWhitespace)));
    }
