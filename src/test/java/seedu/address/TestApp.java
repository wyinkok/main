...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyJobbiBot> initialDataSupplier = () -> null;
    protected String saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyJobbiBot> initialDataSupplier, String saveFileLocation) {
        super();
    ...
    protected UserPrefs initPrefs(UserPrefsStorage storage) {
        ...
        userPrefs.setInternshipBookFilePath(saveFileLocation);
        userPrefs.setInternshipBookName(ADDRESS_BOOK_NAME);
        return userPrefs;
    }
     ...
     */
    public JobbiBot readStorageInternshipBook() {
        try {
    ...
    public String getStorageSaveLocation() {
        return storage.getJobbiBotFilePath();
    }
    ...
    public Model getModel() {
        Model copy = new ModelManager((model.getJobbiBot()), new UserPrefs());
        ModelHelper.setSearchedList(copy, model.getFilteredInternshipList());
        return copy;
    }
