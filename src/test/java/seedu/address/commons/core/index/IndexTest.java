...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthInternshipIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthInternshipIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthInternshipIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthInternshipIndex.equals(fifthInternshipIndex));

        // null -> returns false
        assertFalse(fifthInternshipIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthInternshipIndex.equals(5.0f));
