...
public class BrowserPanelTest extends GuiUnitTest {
    private InternshipPanelSelectionChangedEvent selectionChangedEventStub;
    ...
    public void display() throws Exception {
        ...
        URL expectedInternshipUrl = new URL(BrowserPanel.SEARCH_PAGE_URL + ALICE.getName().fullName.replaceAll(" ", "%20"));
